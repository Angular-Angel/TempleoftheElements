...
class ClawAttackEnemyGenerator extends CreatureGenerationProcedure {
    ...
    public CreatureDefinition modify(CreatureDefinition definition) {
        ...
        attack.stats.addStat("Recovery Time", new NumericStat(1.26));
        ...
        attack.stats.addStat("Movespeed Modifier", new NumericStat(0.5));
        attack.stats.addStat("Stamina Regen Modifier", new NumericStat(0.2));
